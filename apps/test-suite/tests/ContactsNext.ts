...
export async function test(t) {
  ...
  // t.describe('Contact form', () => {
  //   t.fit('should open contact form to edit an existing contact', async () => {
  //     const contactDetails = {
  //       givenName: 'Form',
  //       familyName: 'Tester',
  //       emails: [{ label: 'work', address: 'form_tester@example.com' }],
  //     };
  //     const newContact = await Contact.create(contactDetails);
  //     contacts.push(newContact);
  //     const result = await newContact.editWithForm();
  //     t.expect(result).toBeDefined();
  //   });

  //   t.it('should allow to pick a contact', async () => {
  //     const contactDetails = {
  //       givenName: 'Picker',
  //       familyName: 'Tester',
  //     };
  //     const newContact = await Contact.create(contactDetails);
  //     contacts.push(newContact);
  //     const pickedContact = await Contact.pick();
  //     t.expect(pickedContact).toBeDefined();
  //     t.expect(pickedContact?.id).toBe(newContact.id);
  //   });
  // });
}
